...
return (
  <div className="fixed bottom-5 flex w-full flex-col items-center space-y-3 bg-gradient-to-b from-transparent via-gray-100 to-white p-5 pb-3 sm:px-0">
    <div className="flex flex-col items-stretch w-full max-w-screen-md">
      ...
      >
        <Textarea
          ...
          rows={1}
          autoFocus
          placeholder="이미지를 설명하거나 파일을 업로드하고 @를 입력해보세요."
          value={input}
          onChange={(e) => setInput(e.target.value)}
          onCompositionStart={handleCompositionStart}
          onCompositionEnd={handleCompositionEnd}
          onKeyDown={(e) => {
            if (e.key === "Enter" && !e.shiftKey && chatStarted && !isComposing) {
        ...
        <label 
          ...
          className={clsx(
            ...
            disabled || !chatStarted || isSending
              ...
              : "bg-slate-400 hover:bg-slate-800",
          )}
        >
